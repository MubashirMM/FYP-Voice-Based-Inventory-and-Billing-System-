...
# GROQ_API_KEY1 = settings.GROQ_API_KEY10
# GROQ_API_KEY2 = settings.GROQ_API_KEY11
# GROQ_API_KEY3 = settings.GROQ_API_KEY12
...
#     prompt_path = Path("myapp/prompts/prompt_bills.txt")
