...
# GROQ_API_KEY1 = settings.GROQ_API_KEY7
# GROQ_API_KEY2 = settings.GROQ_API_KEY8
# GROQ_API_KEY3 = settings.GROQ_API_KEY9
...
#     prompt_path = Path("myapp/prompts/prompt_udhaar_items.txt")
...
# async def process_voice_udhaar_items(audio_base64: str, current_user: User, db: AsyncSession):
#     """
