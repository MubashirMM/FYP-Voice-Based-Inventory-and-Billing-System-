...
This project is a web-based Grocery Shop Management System designed specifically for Urdu-speaking users in the Pakistani market. It enables small shop owners to digitally manage their daily operations including stock, billing, and customer credit (Udhaar), with added support for voice interaction using AI.

The system is built with a modern full-stack architecture, combining a React frontend with a FastAPI backend, and integrates AI models for voice-based operations.
...
Supports predefined unit conversions (e.g., kg, grams, liters)
Custom units can be added
Conversion applies only to supported units
🗄️ Database
MySQL used for data storage
Structured relational schema for:
Users
Stock
Bills
Udhaar records
...
Designed for real-world usage with scalable infrastructure
👤 Target User
...
📈 Future Improvements
Multi-user support (roles like cashier, manager)
